    ...
    return makeStyles((theme) => {
        return {
            ...
            essay: {
                ...
                backgroundSize: '56px',
                backgroundImage:
                    'url("https://www.flaticon.com/svg/vstatic/svg/1803/1803690.svg?token=exp=1618303813~hmac=f7719cbff255cd4896c0b4f6cfcade25")',
                backgroundRepeat: 'no-repeat',
                backgroundPosition: 'calc(100% - 10px) 90px',
                '& $iconEssay': {
                    display: 'block'
            ...
            film: {
                ...
                backgroundSize: '56px',
                backgroundImage:
                    'url("https://www.flaticon.com/svg/vstatic/svg/860/860349.svg?token=exp=1618304199~hmac=6e8df57ac50ff65d9825598911838efc")',
                backgroundRepeat: 'no-repeat',
                backgroundPosition: 'calc(100% - 10px) 90px',
                '& $iconFilm': {
                    display: 'block'
...
const JiscTextExample = ({
    ...
    return (
        ...
        >
            ...
            {showFilm && (
                <svg
                    className={classes.iconFilm}
                    xmlns='http://www.w3.org/2000/svg'
                    width='222.608'
                    height='214.153'
                    viewBox='0 0 222.608 214.153'
                >
                    <path
                        id='iconFilm'
                        d='M161.683,1V15.7h-14.7V1h-14.7V30.4H44.1V1H29.4V15.7H14.7V1H0V162.683H14.7v-14.7H29.4v14.7H44.1v-29.4h88.191v29.4h14.7v-14.7h14.7v14.7h14.7V1ZM29.4,133.286H14.7v-14.7H29.4Zm0-29.4H14.7v-14.7H29.4Zm0-29.4H14.7v-14.7H29.4Zm0-29.4H14.7V30.4H29.4Zm102.889,66.143H44.1V52.445h88.191Zm29.4,22.048h-14.7v-14.7h14.7Zm0-29.4h-14.7v-14.7h14.7Zm0-29.4h-14.7v-14.7h14.7Zm0-29.4h-14.7V30.4h14.7Z'
                        transform='translate(-0.358 62.276) rotate(-21)'
                        fill='#fff'
                    />
                </svg>
            )}
            ...
            <Typography item className={classes.textContainer}>
                {exampleText}
            </Typography>
